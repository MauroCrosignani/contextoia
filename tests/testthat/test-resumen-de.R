test_that("contextoia carga el helper IA como paquete independiente", {
  expect_true(exists("resumen_de", mode = "function"))
  expect_true(exists("profile_dataset_for_ai", mode = "function"))
  expect_true(exists("render_dataset_profile_for_ai", mode = "function"))
  expect_equal(ai_profile_slugify("Nombre de Unidad"), "nombre-de-unidad")
})
...
test_that("resumen_de debe quedar exportada en el paquete", {
  expect_true("resumen_de" %in% getNamespaceExports("contextoia"))
})

test_that("la API publica del helper se mantiene en espanol", {
  namespace_exports <- getNamespaceExports("contextoia")

  expect_false("profile_dataset_for_ai" %in% namespace_exports)
  expect_false("render_dataset_profile_for_ai" %in% namespace_exports)
})
